...
<body>
    ...
    <div class="back">
        <div class="container">
            ...
            <fieldset>
            <legend><h2>${userId }님의 섭취 정보입니다<img src="img/bono.gif" width=150px height=150px></h2>
            <br>
            <br>
            </legend>
            </fieldset>
                        ...
                        <div class="row item">
                            ...
                            <h3>${food.name }</h3><h4>수량 : ${food.cnt}</h4> 
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-primary delBt" value="${food.eatfoodcode }">삭제</button>
                                    <button type="button" class="btn btn-primary updateBt" value="${food.eatfoodcode }">수정</button><br>
                                </div>
                        </div>
                    </div>
                </c:when>
    ...
    <div class="back">
        ...
        <c:if test="${kcal == -1}">
            <a><h3 id="best">권장 칼로리 : 추가 정보를 등록하셔야 확인할 수 있습니다.</h3></a>
        </c:if>
        <c:if test="${kcal != -1}">
            <a><h3 id="best">권장 칼로리 : ${kcal }</h3></a>
        </c:if>
        ...
        <c:if test="${kcal>cal}">
            <a><h3 id="cal">섭취 칼로리 : ${cal }</h3></a>
        </c:if>       
        
        <c:if test="${cal>=kcal}">
            <a><h3 id="overcal">섭취 칼로리 : ${cal }</h3></a>
        </c:if>
        ...
        <c:if test="${nat>=2000}">
                <a><h3 id="overnat">섭취한 나트륨 : ${nat }</h3></a>
        </c:if>       
        
        <c:if test="${nat<2000}">
                <a><h3 id="nat">섭취한 나트륨 : ${nat }</h3></a>
        </c:if>   
