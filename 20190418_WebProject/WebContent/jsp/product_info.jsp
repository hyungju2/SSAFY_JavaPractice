...
// 						})
				...
				$('#btAdd').click(function() {
					var contains = document.getElementById("contains").getAttribute("value");
					if ( contains.length > 2){
						...
						form.setAttribute("action", "userAddFood.mvc");
						var input = document.createElement("input");
						input.setAttribute("type", "text");
						input.setAttribute("name","foodCode");
						input.setAttribute("value", document.getElementById("foodCode").getAttribute("value"));
						form.appendChild(input);
						
						input = document.createElement("input");
						input.setAttribute("type", "text");
						input.setAttribute("name", "amount");
						input.setAttribute("value", $('#amount').val());
						form.appendChild(input);
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<h2 class="product">
					제품 정보
					<input id="foodCode" hidden="foodCode" value="${food.code }">
					<input id="foodImg" hidden="foodImg" value="${food.img }">
					...
					<input id="foodNatrium" hidden="foodNatrium" value="${ food.getNatrium()/1000 }">
					...
					<input id="contains" hidden="contains" value="${contains }">
				</h2>
				<hr>
				<table class="table">
					<tbody>
				...
				<div class="col-md-2 col-md-offset-9">
					수량
					<input style="margin-bottom:5px" type="number" id="amount" value="0" min="0" >
					<br>
