	...
	<header>
		<nav class="blackbar">
			<ul>
				<c:if test="${empty user }">
					<li><button id="searchuser">회원 검색</button></li>
		...
		<nav class="logobar">
			...
			<ul>
				...
				<li class="info_my"><c:if test="${not empty user }">
						<a href="myFoodList.mvc">내 섭취정보</a>
					</c:if> <c:if test="${empty user }">
						내 섭취정보
					</c:if></li>
				<li class="info_best">베스트 섭취 정보</li>
				<li class="info_item"><c:if test="${not empty user }">
