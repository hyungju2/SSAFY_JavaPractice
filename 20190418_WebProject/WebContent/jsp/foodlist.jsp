...
<script type="text/javascript">	
	...
	function add(foodCode) {
		alert("상품 추가 페이지로 이동합니다!");
		location.href = 'searchFood.mvc?code=' + foodCode;
	}
	...
	<header>
		...
		<nav class="logobar">
			...
			<ul>
				...
				<li class="info_my"><a href="myFoodList.mvc">내 섭취정보</a></li>
						...
						<div class="row item">
							...
							<div class="col-sm-8 txt">
								...
								<div class="btn-group" role="group">
									<button type="button" class="btn btn-primary" name="addCode" onclick="add(${food.code})">추가</button>
									<button type="button" class="btn btn-primary JJimButton" name="JJimCode" value="${food.code }">찜</button><br>
								</div>
							</div>
						</div>
					</div>
